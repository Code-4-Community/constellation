  ...
  <Form onSubmit={onSubmit ?? alertOnSubmit} initialValues={{}}>
        ...
        {({ field, form }: FieldProps) => (
          ...
          >
            ...
            <Select placeholder="Select Child's Diagnosis" size="md">
              ...
              <option value={CancersDropdownValues.LEUKEMIAS}>
                {' '}
                Leukemias{' '}
              </option>
              <option value={CancersDropdownValues.LYMPHOMAS}>
                {' '}
                Lymphomas{' '}
              </option>
              ...
              <option value={CancersDropdownValues.OTHERCANCERS}>
                {' '}
                Other{' '}
              </option>
            </Select>
    ...
    <Box paddingY="2">
      <Field name="doctorSignature">
        {({ field, form }: FieldProps) => (
          ...
          >
            <FormLabel htmlFor={'doctorSignature'}>
              Doctor's Signature
            </FormLabel>
    ...
    <Box paddingY="2">
      <Field name="medicalFormNotes">
        {({ field, form }: FieldProps) => (
          <FormControl
            isInvalid={Boolean(
              form.errors['medicalFormNotes'] &&
                form.touched['medicalFormNotes']
            )}
          >
    ...
    <Box paddingY="2">
      <Text as="i" fontSize="xs">
        ...
        applications may result in your institution being deemed ineligible for
        this program. Please be sure that the entire application is complete
