  ...
  <Form onSubmit={onSubmit ?? alertOnSubmit} initialValues={{}}>
    ...
    <Box py="2">
      <Text as="i" fontSize="xs">
        ...
        signing this, you are giving your medical professionals and TSWGO
        permission to share medical information about your child’s case as well
        as to share your application with other organizations in an effort to,
        potentially, gain additional funds for you.
      </Text>
    </Box>
  </Form>
);
